                ...
                if (count($args == 2)) {
                    ...
                    if (strtolower($args[0]) == 'info') {
                        if (isset($args[1])) {
                            ...
                            $stmt = $this->plugin->getHomeCoords($factions);
                            $sender->sendMessage(TextFormat::GREEN . TextFormat::ITALIC . "-------INFORMATION-------" . TextFormat::RESET);
                            $sender->sendMessage(TextFormat::GREEN . TextFormat::ITALIC . "|[Faction]| : " . TextFormat::WHITE . "$faction" . TextFormat::RESET);
                            $sender->sendMessage(TextFormat::GREEN . TextFormat::ITALIC . "|(Leader)| : " . TextFormat::WHITE . "$leader" . TextFormat::RESET);
                            $sender->sendMessage(TextFormat::GREEN . TextFormat::ITALIC . "|^Players^| : " . TextFormat::WHITE . "$numPlayers" . TextFormat::RESET);
                            $sender->sendMessage(TextFormat::GREEN . TextFormat::ITALIC . "|&Strength&| : " . TextFormat::WHITE . "$power" . " STR" . TextFormat::RESET);
                            $sender->sendMessage(TextFormat::GREEN . TextFormat::ITALIC . "|*Description*| : " . TextFormat::WHITE . TextFormat::UNDERLINE . "$message" . TextFormat::RESET);
                            $sender->sendMessage(TextFormat::GREEN . TextFormat::ITALIC . "|@Home-Cords@| : " . TextFormat::WHITE . "$stmt" . TextFormat::RESET);
                            $sender->sendMessage(TextFormat::GREEN . TextFormat::ITALIC . "-------INFORMATION-------" . TextFormat::RESET);
                        } else {
